# Article-srmi
Data from article metadata integration a systematic review  (SRMI)

# Softwares utilized:

**For mind map: EDRAWMIND**
...
The data are utilized is FrequencyOf-StrategiesMethodsTechniques-By-Domain.txt
